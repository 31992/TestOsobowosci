...
if(showDownload)
{
    ...
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.quest}>Sangwinik: {Math.round((Number(sang)/(Number(sang)+Number(chol)+Number(mela)+Number(fleg)))*100,3)}%</Text>
      <Text style={styles.quest}>Choleryk: {Math.round((Number(chol)/(Number(sang)+Number(chol)+Number(mela)+Number(fleg)))*100,3)}%</Text>
      <Text style={styles.quest}>Melancholik: {Math.round((Number(mela)/(Number(sang)+Number(chol)+Number(mela)+Number(fleg)))*100,3)}%</Text>
      <Text style={styles.quest}>Flegmatyk: {Math.round((Number(fleg)/(Number(sang)+Number(chol)+Number(mela)+Number(fleg)))*100,3)}%</Text>
